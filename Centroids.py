...
def make_base_centroids(out_file_path, bounds=(-180, -60, 180, 60), res_land_arcsec=300, res_ocean_arcsec=3600,
                        land_buffer=0.1):
...
file_name = os.path.join(SYSTEM_DIR,'earth_centroids_0300as_global.hdf5')
if __name__ == "__main__":
    make_base_centroids(file_name, bounds=(-180, -90, 180, 90))


file_name = os.path.join(SYSTEM_DIR,'earth_centroids_0300as_global_nopoles.hdf5')
if __name__ == "__main__":
